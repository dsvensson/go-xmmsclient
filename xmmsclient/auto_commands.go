...
func (c *Client) MainQuit() (XmmsValue, error) {
	__reply := <-c.dispatch(1, 33, XmmsList{})
	if __reply.err != nil {
...
func (c *Client) MainListPlugins(pluginType int) ([]XmmsDict, error) {
	__reply := <-c.dispatch(1, 34, XmmsList{XmmsInt(pluginType)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) MainStats() (XmmsDict, error) {
	__reply := <-c.dispatch(1, 35, XmmsList{})
	if __reply.err != nil {
...
func (c *Client) PlaylistReplace(name string, replacement XmmsColl, action int) (XmmsValue, error) {
	__reply := <-c.dispatch(2, 32, XmmsList{XmmsString(name), replacement, XmmsInt(action)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaylistSetNext(position int) (XmmsInt, error) {
	__reply := <-c.dispatch(2, 33, XmmsList{XmmsInt(position)})
	if __reply.err != nil {
...
func (c *Client) PlaylistSetNextRel(positionDelta int) (XmmsInt, error) {
	__reply := <-c.dispatch(2, 34, XmmsList{XmmsInt(positionDelta)})
	if __reply.err != nil {
		return 0, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaylistAddUrl(name string, url string) (XmmsValue, error) {
	__reply := <-c.dispatch(2, 35, XmmsList{XmmsString(name), XmmsString(url)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaylistAddCollection(name string, collection XmmsColl) (XmmsValue, error) {
	__reply := <-c.dispatch(2, 36, XmmsList{XmmsString(name), collection})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaylistRemoveEntry(name string, position int) (XmmsValue, error) {
	__reply := <-c.dispatch(2, 37, XmmsList{XmmsString(name), XmmsInt(position)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaylistMoveEntry(name string, position int, newPosition int) (XmmsValue, error) {
	__reply := <-c.dispatch(2, 38, XmmsList{XmmsString(name), XmmsInt(position), XmmsInt(newPosition)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaylistListEntries(name string) ([]int, error) {
	__reply := <-c.dispatch(2, 39, XmmsList{XmmsString(name)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaylistCurrentPos(name string) (XmmsDict, error) {
	__reply := <-c.dispatch(2, 40, XmmsList{XmmsString(name)})
	if __reply.err != nil {
		return XmmsDict{}, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaylistCurrentActive() (XmmsString, error) {
	__reply := <-c.dispatch(2, 41, XmmsList{})
	if __reply.err != nil {
		return "", __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaylistInsertUrl(name string, position int, url string) (XmmsValue, error) {
	__reply := <-c.dispatch(2, 42, XmmsList{XmmsString(name), XmmsInt(position), XmmsString(url)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaylistInsertCollection(name string, position int, collection XmmsColl) (XmmsValue, error) {
	__reply := <-c.dispatch(2, 43, XmmsList{XmmsString(name), XmmsInt(position), collection})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaylistLoad(name string) (XmmsValue, error) {
	__reply := <-c.dispatch(2, 44, XmmsList{XmmsString(name)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaylistRadd(name string, url string) (XmmsValue, error) {
	__reply := <-c.dispatch(2, 45, XmmsList{XmmsString(name), XmmsString(url)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaylistRinsert(name string, position int, url string) (XmmsValue, error) {
	__reply := <-c.dispatch(2, 46, XmmsList{XmmsString(name), XmmsInt(position), XmmsString(url)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) ConfigGetValue(key string) (XmmsString, error) {
	__reply := <-c.dispatch(3, 32, XmmsList{XmmsString(key)})
	if __reply.err != nil {
		return "", __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) ConfigSetValue(key string, value string) (XmmsValue, error) {
	__reply := <-c.dispatch(3, 33, XmmsList{XmmsString(key), XmmsString(value)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) ConfigRegisterValue(key string, value string) (XmmsString, error) {
	__reply := <-c.dispatch(3, 34, XmmsList{XmmsString(key), XmmsString(value)})
	if __reply.err != nil {
		return "", __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) ConfigListValues() (XmmsDict, error) {
	__reply := <-c.dispatch(3, 35, XmmsList{})
	if __reply.err != nil {
		return XmmsDict{}, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaybackStart() (XmmsValue, error) {
	__reply := <-c.dispatch(4, 32, XmmsList{})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaybackStop() (XmmsValue, error) {
	__reply := <-c.dispatch(4, 33, XmmsList{})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaybackPause() (XmmsValue, error) {
	__reply := <-c.dispatch(4, 34, XmmsList{})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaybackTickle() (XmmsValue, error) {
	__reply := <-c.dispatch(4, 35, XmmsList{})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaybackPlaytime() (XmmsInt, error) {
	__reply := <-c.dispatch(4, 36, XmmsList{})
	if __reply.err != nil {
		return 0, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaybackSeekMs(offset int, whence int) (XmmsValue, error) {
	__reply := <-c.dispatch(4, 37, XmmsList{XmmsInt(offset), XmmsInt(whence)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaybackSeekSamples(offset int, whence int) (XmmsValue, error) {
	__reply := <-c.dispatch(4, 38, XmmsList{XmmsInt(offset), XmmsInt(whence)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaybackStatus() (XmmsInt, error) {
	__reply := <-c.dispatch(4, 39, XmmsList{})
	if __reply.err != nil {
		return 0, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaybackCurrentId() (XmmsInt, error) {
	__reply := <-c.dispatch(4, 40, XmmsList{})
	if __reply.err != nil {
		return 0, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaybackVolumeSet(channel string, volume int) (XmmsValue, error) {
	__reply := <-c.dispatch(4, 41, XmmsList{XmmsString(channel), XmmsInt(volume)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) PlaybackVolumeGet() (XmmsDict, error) {
	__reply := <-c.dispatch(4, 42, XmmsList{})
	if __reply.err != nil {
		return XmmsDict{}, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) MedialibGetInfo(id int) (XmmsDict, error) {
	__reply := <-c.dispatch(5, 32, XmmsList{XmmsInt(id)})
	if __reply.err != nil {
		return XmmsDict{}, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) MedialibImportPath(directory string) (XmmsValue, error) {
	__reply := <-c.dispatch(5, 33, XmmsList{XmmsString(directory)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) MedialibRehash(id int) (XmmsValue, error) {
	__reply := <-c.dispatch(5, 34, XmmsList{XmmsInt(id)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) MedialibGetId(url string) (XmmsInt, error) {
	__reply := <-c.dispatch(5, 35, XmmsList{XmmsString(url)})
	if __reply.err != nil {
		return 0, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) MedialibRemoveEntry(id int) (XmmsValue, error) {
	__reply := <-c.dispatch(5, 36, XmmsList{XmmsInt(id)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) MedialibSetPropertyString(id int, source string, key string, value string) (XmmsValue, error) {
	__reply := <-c.dispatch(5, 37, XmmsList{XmmsInt(id), XmmsString(source), XmmsString(key), XmmsString(value)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) MedialibSetPropertyInt(id int, source string, key string, value int) (XmmsValue, error) {
	__reply := <-c.dispatch(5, 38, XmmsList{XmmsInt(id), XmmsString(source), XmmsString(key), XmmsInt(value)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) MedialibRemoveProperty(id int, source string, key string) (XmmsValue, error) {
	__reply := <-c.dispatch(5, 39, XmmsList{XmmsInt(id), XmmsString(source), XmmsString(key)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) MedialibMoveEntry(id int, url string) (XmmsValue, error) {
	__reply := <-c.dispatch(5, 40, XmmsList{XmmsInt(id), XmmsString(url)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) MedialibAddEntry(url string) (XmmsValue, error) {
	__reply := <-c.dispatch(5, 41, XmmsList{XmmsString(url)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) CollectionGet(name string, namespace string) (XmmsValue, error) {
	__reply := <-c.dispatch(6, 32, XmmsList{XmmsString(name), XmmsString(namespace)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) CollectionList(namespace string) ([]string, error) {
	__reply := <-c.dispatch(6, 33, XmmsList{XmmsString(namespace)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) CollectionSave(name string, namespace string, collection XmmsColl) (XmmsValue, error) {
	__reply := <-c.dispatch(6, 34, XmmsList{XmmsString(name), XmmsString(namespace), collection})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) CollectionRemove(name string, namespace string) (XmmsValue, error) {
	__reply := <-c.dispatch(6, 35, XmmsList{XmmsString(name), XmmsString(namespace)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) CollectionFind(id int, namespace string) ([]string, error) {
	__reply := <-c.dispatch(6, 36, XmmsList{XmmsInt(id), XmmsString(namespace)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) CollectionRename(name string, newName string, namespace string) (XmmsValue, error) {
	__reply := <-c.dispatch(6, 37, XmmsList{XmmsString(name), XmmsString(newName), XmmsString(namespace)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) CollectionQuery(collection XmmsColl, fetch XmmsDict) (XmmsValue, error) {
	__reply := <-c.dispatch(6, 38, XmmsList{collection, fetch})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
// FIXME.
func (c *Client) CollectionQueryInfos(collection XmmsColl, limitStart int, limitLength int, properties []string, groupBy []string) ([]XmmsDict, error) {
	__reply := <-c.dispatch(6, 39, XmmsList{collection, XmmsInt(limitStart), XmmsInt(limitLength), XmmsStrings(properties), XmmsStrings(groupBy)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) CollectionIdlistFromPlaylist(url string) (XmmsValue, error) {
	__reply := <-c.dispatch(6, 40, XmmsList{XmmsString(url)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) XformBrowse(url string) ([]XmmsDict, error) {
	__reply := <-c.dispatch(9, 32, XmmsList{XmmsString(url)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) BindataRetrieve(hash string) (XmmsValue, error) {
	__reply := <-c.dispatch(10, 32, XmmsList{XmmsString(hash)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) BindataAdd(rawData XmmsValue) (XmmsString, error) {
	__reply := <-c.dispatch(10, 33, XmmsList{rawData})
	if __reply.err != nil {
		return "", __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) BindataRemove(hash string) (XmmsValue, error) {
	__reply := <-c.dispatch(10, 34, XmmsList{XmmsString(hash)})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) BindataList() ([]string, error) {
	__reply := <-c.dispatch(10, 35, XmmsList{})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) CourierSendMessage(toClient int, replyPolicy int, payload XmmsDict) (XmmsValue, error) {
	__reply := <-c.dispatch(12, 32, XmmsList{XmmsInt(toClient), XmmsInt(replyPolicy), payload})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) CourierReply(messageId int, replyPolicy int, payload XmmsDict) (XmmsValue, error) {
	__reply := <-c.dispatch(12, 33, XmmsList{XmmsInt(messageId), XmmsInt(replyPolicy), payload})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) CourierGetConnectedClients() ([]int, error) {
	__reply := <-c.dispatch(12, 34, XmmsList{})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) CourierReady() (XmmsValue, error) {
	__reply := <-c.dispatch(12, 35, XmmsList{})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
...
func (c *Client) CourierGetReadyClients() ([]int, error) {
	__reply := <-c.dispatch(12, 36, XmmsList{})
	if __reply.err != nil {
		return nil, __reply.err
	}
	__buffer := bytes.NewBuffer(__reply.payload)
